...
function infoDetalleOT() {
    ...
    // Nombre taller
    document.getElementById("nomTalleres").innerHTML = "<font color='red' style='font-size: 12px; font-weight: bold'>TALLER:&nbsp; </font><font style='font-size: 12px'>" + localStorage.getItem("ls_nomtall").toLocaleString() + '  </font><br />';
    // Observaciones
...
//    window.plu.plugins.socialsharing.shareViaSMS('My cool message', null /* see the note below */, alert('ok: ' + msg), alert('error: ' + msg));
//    alert("33");
//}
