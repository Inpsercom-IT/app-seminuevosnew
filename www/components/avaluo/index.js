            ...
            $.ajax({
                ...
                success: function (datas) {
                    ...
                    if (datas.substr(0, 1) == "1") {
                        ...
                        //vaciaCamposUsa();
                        //return;
                    } else { alert("mensaje: "+datas.substr(2, datas.length - 2)); return; }
                },
        ...
        $.ajax({
            ...
            success: function (data1) {
                ...
                if (data1.substr(0, 1) == "1" || data1 == "") {
                    ...
                    //return;
                } else { alert("Mensaje "+data1.substr(0, data1.length - 2));return; }
            },
            ...
            success: function (data) {
                try {
                    ...
                    if (infor.substr(0, 1) == "1") {
                        ...
                        //vaciaCamposUsa();
                        //return;
                    } else { alert("Mensaje : "+infor.substr(2, infor.length - 2)); return; }
                } catch (e) {
                    alert(e);
                    recurrenteOT = 1;
                }
